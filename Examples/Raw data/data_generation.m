...
[hadamard_patterns, without_complement] = generateHadamardCodes(nlocations_and_offset, binning, cdim, rdim);
...
function [hadamard_patterns, without_complement] = generateHadamardCodes(nlocations_and_offset, binning, npix_x, npix_y)
